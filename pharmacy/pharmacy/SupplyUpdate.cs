...
namespace pharmacy
{
    public partial class SupplyUpdate : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.Connection = con;
                SqlCommand myCommand = new SqlCommand("Update Supply Set Amount = '" +
                Int32.Parse(Amount.ToString()) + "' Where ProductName = '" + ProductName + "'", con);
