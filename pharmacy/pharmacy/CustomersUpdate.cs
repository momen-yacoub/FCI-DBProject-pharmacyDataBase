    ...
    public partial class CustomersUpdate : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.Connection = con;
                SqlCommand myCommand = new SqlCommand("Update Customers set Name = '" +
                Name.ToString() + "',Mobile = '" + Mobile.ToString() + "',Age = '" + Int32.Parse(Age.ToString()) + "' Where CustomerNumber = " + Int32.Parse(CustomerNumber.ToString()), con);
