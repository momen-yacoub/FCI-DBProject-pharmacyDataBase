...
namespace pharmacy
{
    public partial class SalesPersonUpdate : Form
    {
        ...
        public SalesPersonUpdate()
        {
            InitializeComponent();
        }

        private void SalesPersonUpdate_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.Connection = con;
                SqlCommand myCommand = new SqlCommand("Update SalesPerson set Name = '" +
                Name.ToString() +"',Mobile = '" + Mobile.ToString() + "',Salary = '" + float.Parse(Salary.ToString()) + "' Where ID = '" + ID + "'", con);
